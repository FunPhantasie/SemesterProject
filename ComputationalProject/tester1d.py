...
from explicit_particle_sim import PIC_Explicit
import numpy as np
...
total_steps = int(5.0 / solver_test.dt)
...
"""
#ax3.plot(t_history, a, '-', label='Total Energy')
#ax3.plot(t_history, b, '-', label='Kinetic Energy')
ax3.plot(t_history, c, '-', label='Total Energy Ref')
